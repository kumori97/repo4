 %% 3.优化求最小值的方法
clear, clc
waist_length = zeros(300,1);
for i = 0:299
    i = num2str(i);
    filex = strcat('./waists/',i,'x.txt');
    filey = strcat('./waists/',i,'y.txt');
    x = load(filex);
    y = load(filey);
   ...
   % axis square
    ...
    i = str2num(i);
    waist_length(i+1,1) = perimeter;
    %filename = strcat('./waist_perimeter/waist',i,'.txt')
    %save(filename,'perimeter','-ascii')
end
xlswrite('C:\Users\kumori\Desktop\Parameter_statistics.xlsx',{'waist'},'B1:B1')
xlswrite('C:\Users\kumori\Desktop\Parameter_statistics.xlsx',waist_length,'B2:B301')