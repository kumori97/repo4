 %% 3.优化求最小值的方法
clear, clc
chest_length = zeros(300,1);
for i = 0:299
    i = num2str(i);
    filex = strcat('./chest/',i,'x.txt');
    filey = strcat('./chest/',i,'y.txt');
    x = load(filex);
    y = load(filey);
   ...
   % axis square
    ...
    i = str2num(i);
    chest_length(i+1,1) = perimeter;
    %filename = strcat('./chest_perimeter/waist',i,'.txt')
    %save(filename,'perimeter','-ascii')
end
xlswrite('C:\Users\kumori\Desktop\Parameter_statistics.xlsx',{'chest'},'C1:C1')
xlswrite('C:\Users\kumori\Desktop\Parameter_statistics.xlsx',chest_length,'C2:C301')